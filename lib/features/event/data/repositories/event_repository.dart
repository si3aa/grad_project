...
class EventRepository {
  ...
  Future<bool> addProductToEvent(String eventId, String productId) async {
    try {
      String? token = await _authDataSource.getToken();
      if (token == null) {
        throw UnauthorizedException('No authentication token found.');
      ...
      print('=== Adding Product to Event ===');
      print('Event ID: $eventId');
      print('Product ID: $productId');
      print('Request URL: $_baseUrl/events/$eventId/products/$productId');
      print('Headers: ${_dio.options.headers}');

      final response = await _dio.post(
        '$_baseUrl/events/$eventId/products/$productId',
        options: Options(
          headers: {
      ...
      print('=== Error Adding Product to Event ===');
      print('Event ID: $eventId');
      print('Product ID: $productId');
      print('Error: $e');
  ...
  Future<bool> removeProductFromEvent(String eventId, String productId) async {
    try {
      ...
      _dio.options.headers['Authorization'] = 'Bearer $token';
      final url = '$_baseUrl/events/$eventId/products/$productId';
      ...
      print('\n=== Error Removing Product from Event ===');
